...
function timeago($timestring, $timezone = NULL) {
  if($timestring =="0000-00-00 00:00:00" || $timestring =="0000/00/00 00:00:00" || empty($timestring)){
    return "--";
  }else{   
   
    $date1 = date("Y/m/d H:i:s",strtotime ('-1 days -18hours -05 minutes', strtotime($timestring) )) ;
    $timeAgo = new TimeAgo($timezone);
    $time_var = $timeAgo->inWords($date1, "now");
    return $time_var." ago";
  }
}
